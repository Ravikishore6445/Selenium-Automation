...
<td><font size =2><b>TESTCASE</b></font></td>
...
out.println("<b>" + "<font size =2>"+ "Load URl for"+ " "+site + "</font>"+"</b>");
...
String query = "select * from sittc where site ="+"'"+site+"'";

System.out.println("Query is"+ " "+query);

ResultSet rs = st.executeQuery("select * from sittc where site ="+"'"+site+"'");
while(rs.next())
{
...
out.println("<td>"+"<font size =2>"+"<b>"+tid+"<font size =2>"+"<b>"+"</td>");


//out.println("<td class = \"tableheader\">"+testcase+"</td>");
//out.println("<td>"+testcase+"</td>");
out.println("<td>"+"<font size =2>"+"<b>"+testcase+"<font size =2>"+"<b>"+"</td>");
...
<form name = "getcases" method = "get" action = "IGTSITExecuter.jsp">
