...
function selectdate(did,sid)
{
	...
	alert(sid);
	  ...
	  xmlhttp.open("GET","MyResults1.jsp?q="+did,true);
...
<div id="main">
	<div id="header">
		...
		<div class="container">
		  ...
		  <div class="col-sm-2"><p><b><h3>Sites</h3></b> 
   <select name = "site">
  
  <option value = "BidBingo">BidBingo</option>
  <option value = "CaliberBingo">Caliber</option>
  <option value = "Butlins">Butlins</option>
  <option value = "Carlton">Carlton</option>
  <option value = "Castle">Castle</option>
  <option value = "Club3000">Club3000</option>
  <option value = "DailyExpress">DailyExpress</option>
  <option value ="DailyStar">DailyStar</option>
  <option value = "RoyalGames">RoyalGames</option>
  <option value = "Ballet">Ballet</option>
  <option value = "HappyBingo">HappyBingo</option>
  <option value = "SpelHallen">SpelHallen</option>
  <option value = "OkBingo">OKBingo</option>
  <option value = "LyckoBingo">LyckoBingo</option>
  <option value = "SlotNGames">SlotNGames</option>
  ...
  <div class="col-sm-2 col-sm-offset-1">
	<p><b><h2>Date:</h2></b>  <input type="text" id="datepicker" ></p>
