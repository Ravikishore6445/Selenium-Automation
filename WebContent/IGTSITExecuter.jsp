...
<%@ page import="java.sql.*"%>
	...
	<%@ page import="Execution.testsitExecute"%>
...
//System.out.println("Site is"+ " "+URL);
	...
	System.out.println("Is it Executing tis query");

	 
	String query = "select testcase from sittc where ID in("+tids+") and URL ="+ "'"+URL+"'"; 
	...
	//out.println("<b>"+"Testcase for Execution are"+"</b>");
	  ...
	  testsitExecute t1 = new testsitExecute();
     // t1.setup(URL);
	...
	while (rs.next()) {
		...
		System.out.println(tcaseselected);
